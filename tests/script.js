  ...
  "pagina3": `
    <div class="container">
        ...
        <div id="enlaces">
            ...
            <button id="iniciobtn" class="juego">Volver al inicio</button>
        </div>
...
function cargarHTML(pagina) {
  ...
  //-------------------------------------PAGINA 2-------------------------------------
    ...
    document.body.innerHTML = paginas[pagina]
    resetearBotones();;
    document.querySelector('#volverArrow').onclick = () => {cargarHTML('pagina1');};
    ...
    document.querySelector('#iniciobtn').onclick = () => {cargarHTML('pagina1');};
